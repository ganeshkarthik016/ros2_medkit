# Contributing to DiagTree

Thanks for your interest in contributing to DiagTree! This guide explains how to report issues, suggest features, and contribute code.

## How to Report Issues

### Did you find a bug?

- **Ensure the bug was not already reported** by searching [Issues](https://github.com/bburda/DiagTree/issues)
- If you can't find an existing issue, [open a new one](https://github.com/bburda/DiagTree/issues/new/choose) and select the **Bug report** template
- Fill in all sections of the template:
  ...
  - **Environment** - DiagTree version, ROS 2 distro, OS
  - **Additional information** - logs, snippets, or screenshots if helpful

### Do you want to suggest a feature or improvement?

- Check if the feature has already been suggested in [Issues](https://github.com/bburda/DiagTree/issues)
- If not, [open a new issue](https://github.com/bburda/DiagTree/issues/new/choose) and select the **Feature request / General issue** template
...
- For questions about **using DiagTree**, open a [Discussion](https://github.com/bburda/DiagTree/discussions) or an Issue with the question label
- For questions about **contributing**, feel free to ask in your PR or Issue
- For **security vulnerabilities**, see [`SECURITY.md`](SECURITY.md)

## Code of Conduct

By contributing to DiagTree, you agree to abide by our [Code of Conduct](CODE_OF_CONDUCT.md). Please be respectful and considerate in all interactions.

## License

By contributing to DiagTree, you agree that your contributions will be licensed under the Apache License 2.0.

---

Thank you for improving DiagTree! We value contributions of all sizes - from typo fixes to major features. 🚀
